...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "auralink-dev-secret-key-change-in-production")
...
WSGI_APPLICATION = "auralink.wsgi.application"
ASGI_APPLICATION = "auralink.asgi.application"

# Channel Layers (InMemory for dev, Redis for prod)
...
# Heartbeat threshold (seconds) — if no heartbeat for this long, mark offline
